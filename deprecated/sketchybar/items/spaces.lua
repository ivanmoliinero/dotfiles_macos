...
local spaceConfigs <const> = {
  ["MISCELLANEOUS"] = { icon = "󱞁", name = "MISC" },
  ["CLOUDLAB"] = { icon = "", name = "CLOUDLAB" },
  ["DEUTSCH"] = { icon = "󰖟", name = "DEUTSCH" },
}
...
local function addWorkspaceItem(workspaceName)
  ...
  local spaceConfig = spaceConfigs[workspaceName] or { icon = "󰚩", name = workspaceName }
...
currentWorkspaceWatcher:subscribe(constants.events.AEROSPACE_WORKSPACE_LIST_CHANGED, function(env)
  for sid, item in pairs(spaces) do
    if item ~= nil then
      sbar.remove(sid)
